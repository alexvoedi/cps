...
`,[R("absolute-positioned",`
 ...
 `)]),Zt=Object.assign(Object.assign({},Q.props),{inverted:Boolean,position:He,bordered:Boolean}),Qt=D({name:"LayoutFooter",props:Zt,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:t}=de(e),n=Q("Layout","-layout-footer",Xt,Le,e,o),r=x(()=>{const{common:{cubicBezierEaseInOut:l},self:s}=n.value,a={"--n-bezier":l};return e.inverted?(a["--n-color"]=s.footerColorInverted,a["--n-text-color"]=s.textColorInverted,a["--n-border-color"]=s.footerBorderColorInverted):(a["--n-color"]=s.footerColor,a["--n-text-color"]=s.textColor,a["--n-border-color"]=s.footerBorderColor),a}),i=t?ue("layout-footer",x(()=>e.inverted?"a":"b"),r,e):void 0;return{mergedClsPrefix:o,cssVars:t?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;const{mergedClsPrefix:o}=this;return(e=this.onRender)===null||e===void 0||e.call(this),c("div",{class:[`${o}-layout-footer`,this.themeClass,this.position&&`${o}-layout-footer--${this.position}-positioned`,this.bordered&&`${o}-layout-footer--bordered`],style:this.cssVars},this.$slots)}}),Jt=b("layout-sider",`
 flex-shrink: 0;
 box-sizing: border-box;
 position: relative;
 z-index: 1;
...
`,[R("bordered",[y("border",`
 ...
 `)]),ae("disabled",[ae("selected, child-active",[N("&:focus-within",Qe)]),R("selected",[le(null,[y("icon","color: var(--n-item-icon-color-active-hover-horizontal);"),b("menu-item-content-header",`
 ...
 `,[N("a","color: var(--n-item-text-color-child-active-hover-horizontal);"),y("extra","color: var(--n-item-text-color-child-active-hover-horizontal);")])])]),le("border-bottom: 2px solid var(--n-border-color-horizontal);",Qe)]),b("menu-item-content-header",[N("a","color: var(--n-item-text-color-horizontal);")])])]),ae("responsive",[b("menu-item-content-header",`
 overflow: hidden;
